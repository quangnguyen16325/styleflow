...
app.use("/admin/analytics", requireAuth, requireRole("admin", "staff"), adminAnalyticsRouter);
app.use("/admin/inventory", requireAuth, requireRole("admin", "staff"), adminInventoryRouter);
