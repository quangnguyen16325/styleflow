    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        ...
        <View style={styles.bannerContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?q=80&w=800&auto=format&fit=crop' }}
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <View style={styles.timerRow}>
              ...
              <View style={styles.timerBox}><Text style={styles.timerNum}>36</Text></View>
              <Text style={styles.timerColon}>:</Text>
              <View style={styles.timerBox}><Text style={styles.timerNum}>58</Text></View>
            </View>
          </View>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.hList}>
...
const styles = StyleSheet.create({
  ...
  bannerOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, padding: 22, justifyContent: 'center' },
  bannerSubtitle: { color: 'rgba(255,255,255,0.8)', fontSize: 13, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 4 },
  bannerTitle: { color: '#FFFFFF', fontSize: 34, fontWeight: '900', marginBottom: 14, letterSpacing: -0.5 },
  bannerBadge: { backgroundColor: COLORS.accent, alignSelf: 'flex-start', paddingHorizontal: 14, paddingVertical: 7, borderRadius: 10 },
  bannerBadgeText: { color: '#FFFFFF', fontWeight: '800', fontSize: 14 },

  // Sections
  section: { marginTop: 20, marginBottom: 4 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingRight: 20, marginBottom: 14 },
  sectionTitle: { fontSize: 20, fontWeight: '800', color: COLORS.textPrimary, marginLeft: 20, marginBottom: 14 },
  ...
  timerBox: { backgroundColor: COLORS.textPrimary, borderRadius: 6, paddingHorizontal: 6, paddingVertical: 4, overflow: 'hidden' },
  ...
  categoryIconContainer: { width: 60, height: 60, borderRadius: 30, backgroundColor: COLORS.primaryBg, borderWidth: 1.5, borderColor: COLORS.border, justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
  categoryIconText: { fontSize: 26 },
  categoryName: { fontSize: 12, color: COLORS.textSecondary, fontWeight: '600', textAlign: 'center' },

  // Flash Sale cards
  flashSaleCard: { width: 136, marginHorizontal: 6, backgroundColor: COLORS.bgCard, borderRadius: 14, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 3 },
  flashSaleImage: { width: '100%', height: 136, backgroundColor: '#f1f1f1' },
  discountBadge: { position: 'absolute', top: 8, left: 8, backgroundColor: COLORS.accent, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 6 },
  ...
  flashSaleOldPrice: { fontSize: 12, color: COLORS.textMuted, textDecorationLine: 'line-through', marginTop: 2 },

  // API product cards (horizontal)
  apiProductCard: { width: 140, marginHorizontal: 6, backgroundColor: COLORS.bgCard, borderRadius: 14, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 3 },
  apiProductImage: { width: '100%', height: 140, backgroundColor: '#f1f1f1' },
  apiProductInfo: { padding: 10 },
  apiProductName: { fontSize: 13, color: COLORS.textPrimary, fontWeight: '600', marginBottom: 4, lineHeight: 18 },
  apiProductPrice: { fontSize: 15, fontWeight: '800', color: COLORS.primary },

  // Out of stock badge
  outOfStockBadge: { position: 'absolute', top: 8, right: 8, backgroundColor: COLORS.danger, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 6 },
  ...
  gridCard: { width: (width / 2) - 20, backgroundColor: COLORS.bgCard, marginBottom: 14, borderRadius: 16, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 3 },
  gridImage: { width: '100%', height: 180, backgroundColor: '#f1f1f1', resizeMode: 'cover' },
  gridInfo: { padding: 12 },
  gridName: { fontSize: 13, color: COLORS.textPrimary, fontWeight: '600', lineHeight: 19, height: 38, marginBottom: 6 },
